...
대화형 생성 인공지능(Generative AI) 챗GPT(chatGPT)의 오픈AI CEO **샘 알트만(Sam Altman)** 은 인공지능 기술이 우리가 알고 있는 사회를 재구성할 것이라며, 실제 위험이 따르지만 우리의 삶을 획기적으로 개선하기 위해 '인류가 지금까지 개발한 가장 위대한 기술'이 될 수도 있다고 믿는다고 17일(현지시간) ABC 방송을 통해 밝혔다. 
...
### 뉴스 요악
추 후 미래에는 AI가 사회를 재구성하여 지배하고 일자리를 대체할 수도 있다. 
기존 챗GPT 및 GPT-3는 텍스트로 제한되었지만 GPT-4는 이미지를 보고 이해하고 설명할 수 있는 수준으로 성능이 발전했다. 

### 느낀점

인공지능이 세상을 지배하는 시대가 점점 더 가까이 다가오고 있다고 느껴진다 

---
### 작성자
임근웅
### 뉴스 요약
AI는 위험하면서도 사회를 혁신적으로 바꾸고 인류의 삶을 개선할 가능성이 있다
### 느낀점
AI에 의해 바뀌게될 세상에서 잘 적응 하고 선도해 나갈 수 있도록 지식을 쌓아야 겠다.
...
노현정
### 뉴스요약
Chat-4의 발전에 따른 사회재구성, 일자리 대체 가능성의 우려와 인공지능 기술 가능성의 희망을 보여주고 있다. 
### 느낀점
인공지능을 이용하고 개발하는 것에 많은 것을 생각해야 함을 느꼈다.
